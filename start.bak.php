...
mysql_close($conn);
         ...
         $to = "$EMAIL"; 
         $message = "<a href='www.ipanemaplus.com.br/krill/enter.php?name=$NAME'>CLICK HERE TO ACTIVATE YOUR ACCOUNT</a>";
         $message .= "<h1>$NAME</h1>";
		 $message .= "If your technology does not let you click on the link above then copy and paste this into your browser, and then ask someone to fix your email to enable clickable links. 
<br>
'www.ipanemaplus.com.br/krill/enter.php?name=$NAME'
<br><ul><li>
...
Unless you're an incredibly dull personsn the things you want to do will change over time so you can modify your list along the way. There's nothing wrong with being incredibly dull, you can freeze your list whenever you want</li><li>
Watch a whole bunch of little animations we haven't created yet for the most popular items. We're loving on Edward Gorey/Lemony Snickett/Terry Gilliam style but it all depends on who finds us that wants to *UCKET as much as we do</li><li>
