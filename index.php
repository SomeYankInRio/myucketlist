...
<html >
  <head>
    ...
    <link rel="stylesheet" href="css/normalize.css">
	 ...
	 html { 
  background: url("images/bucket.jpg") no-repeat center center fixed; 
...
$_SESSION["USER_NAME"] = "";					
  ...
  <form method="post" action="start.php">
    <div class="tag">*UCKET</div>
    <div>Sign up below</div>
    <div>
      <input type="text" name="name" id="name"  placeholder="pick a user name:">
    </div>
     <div>
    ...
    <div>
     <button type="submit" class="btn" name="add" >GO</button> 
     
    <!--  <input name="add" type="submit" id="add" value="GO" class="btn"> -->
    </div>
  </form>
</div>
